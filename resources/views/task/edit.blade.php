                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('tasks.update', $task) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" class="form-control @error('description') is-invalid @enderror" name="description" autocomplete="description" autofocus>{{ old('description') ?? $task->description}}</textarea>
